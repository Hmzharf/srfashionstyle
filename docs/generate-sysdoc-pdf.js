...
const mdPath = path.join(__dirname, 'system-documentation.md');
...
<div class="cover-page">
  ...
  <div class="doc-title">Dokumentasi Sistem</div>
  <div class="divider"></div>
  <div class="meta">
    <strong>Isi:</strong> Arsitektur · Kebutuhan · Teknologi · Fitur · Integrasi · Instalasi &nbsp;|&nbsp;
    <strong>Tanggal:</strong> 24 Juni 2026
  </div>
  <div class="badge-row">
    <div class="badge">
...
async function generate() {
  ...
  const htmlPath = path.join(__dirname, 'system-documentation.html');
  ...
  const pdfPath = path.join(__dirname, 'system-documentation-v2.pdf');
  ...
  await page.pdf({
    ...
    headerTemplate: `
      <div style="font-size:7pt; font-family:'Segoe UI',sans-serif; color:#94a3b8;
        ...
        <span style="font-weight:600;">SRFashionStyle — Dokumentasi Sistem</span>
  ...
  const finalPath = path.join(__dirname, 'system-documentation.pdf');
  try { fs.unlinkSync(finalPath); } catch(e) { /* locked — keep v2 */ }
  try { fs.renameSync(pdfPath, finalPath); } catch(e) {
    console.log('Note: PDF saved as system-documentation-v2.pdf (old file locked)');
  }
